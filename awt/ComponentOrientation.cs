...
namespace java.awt
{
	...
	/// </summary>
	[Serializable]
	public sealed class ComponentOrientation
	{
		/*
		 * serialVersionUID
		 */
		...
		private const int UNK_BIT = 1;
		private const int HORIZ_BIT = 2;
		private const int LTR_BIT = 4;

		/// <summary>
		/// Items run left to right and lines flow top to bottom
		/// Examples: English, French.
		/// </summary>
		public static readonly ComponentOrientation LEFT_TO_RIGHT = new ComponentOrientation(HORIZ_BIT | LTR_BIT);

		/// <summary>
		/// Items run right to left and lines flow top to bottom
		/// Examples: Arabic, Hebrew.
		/// </summary>
		public static readonly ComponentOrientation RIGHT_TO_LEFT = new ComponentOrientation(HORIZ_BIT);
		...
		/// </summary>
		public static readonly ComponentOrientation UNKNOWN = new ComponentOrientation(HORIZ_BIT | LTR_BIT | UNK_BIT);
