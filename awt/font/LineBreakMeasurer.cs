...
namespace java.awt.font
{
	...
	public sealed class LineBreakMeasurer
	{
		...
		public LineBreakMeasurer(AttributedCharacterIterator text, FontRenderContext frc) : this(text, BreakIterator.LineInstance, frc)
		{
		}
		...
		public TextLayout NextLayout(float wrappingWidth, int offsetLimit, bool requireNextWord)
		{
