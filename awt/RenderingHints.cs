...
namespace java.awt
{
	...
	/// </para>
	/// </summary>
	public class RenderingHints : Map<Object, Object>, Cloneable
	{
		/// <summary>
		...
		{
			internal static Dictionary<Object, Object> Identitymap = new Dictionary<Object, Object>(17);
	...
	//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
					return this.GetType().FullName + "@" + System.identityHashCode(this.GetType()).ToString("x") + ":" + Privatekey.ToString("x");
				}
			}

			internal static void RecordIdentity(Key java)
			{
				lock (typeof(Key))
				{
					Object identity = java.util.Map_Fields.k.Identity;
					Object otherref = Identitymap.Get(identity);
					if (otherref != java.util.Map_Fields.Null)
					{
						Key otherkey = (Key)((WeakReference) otherref).get();
						if (otherkey != java.util.Map_Fields.Null && otherkey.GetType() == java.util.Map_Fields.k.GetType())
						{
					...
					Identitymap.Put(identity, new WeakReference<Key>(java.util.Map_Fields.k));
				}
			}
			...
			protected internal Key(int privatekey)
			{
		...
		internal Dictionary<Object, Object> Hintmap = new Dictionary<Object, Object>(7);
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_ANTIALIASING = SunHints.KEY_ANTIALIASING;

		/// <summary>
		/// Antialiasing hint value -- rendering is done with antialiasing. </summary>
		/// <seealso cref= #KEY_ANTIALIASING </seealso>
		public static readonly Object VALUE_ANTIALIAS_ON = SunHints.VALUE_ANTIALIAS_ON;

		/// <summary>
		/// Antialiasing hint value -- rendering is done without antialiasing. </summary>
		/// <seealso cref= #KEY_ANTIALIASING </seealso>
		public static readonly Object VALUE_ANTIALIAS_OFF = SunHints.VALUE_ANTIALIAS_OFF;

		/// <summary>
		/// Antialiasing hint value -- rendering is done with a default
		/// antialiasing mode chosen by the implementation. </summary>
		/// <seealso cref= #KEY_ANTIALIASING </seealso>
		public static readonly Object VALUE_ANTIALIAS_DEFAULT = SunHints.VALUE_ANTIALIAS_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_RENDERING = SunHints.KEY_RENDERING;
		...
		public static readonly Object VALUE_RENDER_SPEED = SunHints.VALUE_RENDER_SPEED;

		/// <summary>
		/// Rendering hint value -- rendering algorithms are chosen
		/// with a preference for output quality. </summary>
		/// <seealso cref= #KEY_RENDERING </seealso>
		public static readonly Object VALUE_RENDER_QUALITY = SunHints.VALUE_RENDER_QUALITY;
		...
		/// vs. quality. </summary>
		/// <seealso cref= #KEY_RENDERING </seealso>
		public static readonly Object VALUE_RENDER_DEFAULT = SunHints.VALUE_RENDER_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_DITHERING = SunHints.KEY_DITHERING;

		/// <summary>
		/// Dithering hint value -- do not dither when rendering geometry. </summary>
		/// <seealso cref= #KEY_DITHERING </seealso>
		public static readonly Object VALUE_DITHER_DISABLE = SunHints.VALUE_DITHER_DISABLE;

		/// <summary>
		/// Dithering hint value -- dither when rendering geometry, if needed. </summary>
		/// <seealso cref= #KEY_DITHERING </seealso>
		public static readonly Object VALUE_DITHER_ENABLE = SunHints.VALUE_DITHER_ENABLE;

		/// <summary>
		/// Dithering hint value -- use a default for dithering chosen by
		/// the implementation. </summary>
		/// <seealso cref= #KEY_DITHERING </seealso>
		public static readonly Object VALUE_DITHER_DEFAULT = SunHints.VALUE_DITHER_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_TEXT_ANTIALIASING = SunHints.KEY_TEXT_ANTIALIASING;
		...
		public static readonly Object VALUE_TEXT_ANTIALIAS_ON = SunHints.VALUE_TEXT_ANTIALIAS_ON;

		/// <summary>
		/// Text antialiasing hint value -- text rendering is done without
		/// any form of antialiasing. </summary>
		/// <seealso cref= #KEY_TEXT_ANTIALIASING </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_OFF = SunHints.VALUE_TEXT_ANTIALIAS_OFF;
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_DEFAULT = SunHints.VALUE_TEXT_ANTIALIAS_DEFAULT;
		...
		/// @since 1.6 </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_GASP = SunHints.VALUE_TEXT_ANTIALIAS_GASP;
		...
		/// </para>
		/// <para>Selecting a value which does not match the LCD display in use
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING
		/// @since 1.6 </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_LCD_HRGB = SunHints.VALUE_TEXT_ANTIALIAS_LCD_HRGB;
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING
		/// @since 1.6 </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_LCD_HBGR = SunHints.VALUE_TEXT_ANTIALIAS_LCD_HBGR;
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING
		/// @since 1.6 </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_LCD_VRGB = SunHints.VALUE_TEXT_ANTIALIAS_LCD_VRGB;
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING
		/// @since 1.6 </seealso>
		public static readonly Object VALUE_TEXT_ANTIALIAS_LCD_VBGR = SunHints.VALUE_TEXT_ANTIALIAS_LCD_VBGR;
		...
		/// <seealso cref= #KEY_TEXT_ANTIALIASING
		/// @since 1.6 </seealso>
		public static readonly Key KEY_TEXT_LCD_CONTRAST = SunHints.KEY_TEXT_ANTIALIAS_LCD_CONTRAST;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_FRACTIONALMETRICS = SunHints.KEY_FRACTIONALMETRICS;
		...
		public static readonly Object VALUE_FRACTIONALMETRICS_OFF = SunHints.VALUE_FRACTIONALMETRICS_OFF;

		/// <summary>
		/// Font fractional metrics hint value -- character glyphs are
		/// positioned with sub-pixel accuracy. </summary>
		/// <seealso cref= #KEY_FRACTIONALMETRICS </seealso>
		public static readonly Object VALUE_FRACTIONALMETRICS_ON = SunHints.VALUE_FRACTIONALMETRICS_ON;

		/// <summary>
		/// Font fractional metrics hint value -- character glyphs are
		/// positioned with accuracy chosen by the implementation. </summary>
		/// <seealso cref= #KEY_FRACTIONALMETRICS </seealso>
		public static readonly Object VALUE_FRACTIONALMETRICS_DEFAULT = SunHints.VALUE_FRACTIONALMETRICS_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_INTERPOLATION = SunHints.KEY_INTERPOLATION;
		...
		public static readonly Object VALUE_INTERPOLATION_NEAREST_NEIGHBOR = SunHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR;
		...
		/// </summary>
		/// <seealso cref= #KEY_INTERPOLATION </seealso>
		public static readonly Object VALUE_INTERPOLATION_BILINEAR = SunHints.VALUE_INTERPOLATION_BILINEAR;
		...
		/// </summary>
		/// <seealso cref= #KEY_INTERPOLATION </seealso>
		public static readonly Object VALUE_INTERPOLATION_BICUBIC = SunHints.VALUE_INTERPOLATION_BICUBIC;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_ALPHA_INTERPOLATION = SunHints.KEY_ALPHA_INTERPOLATION;
		...
		public static readonly Object VALUE_ALPHA_INTERPOLATION_SPEED = SunHints.VALUE_ALPHA_INTERPOLATION_SPEED;

		/// <summary>
		/// Alpha interpolation hint value -- alpha blending algorithms
		/// are chosen with a preference for precision and visual quality. </summary>
		/// <seealso cref= #KEY_ALPHA_INTERPOLATION </seealso>
		public static readonly Object VALUE_ALPHA_INTERPOLATION_QUALITY = SunHints.VALUE_ALPHA_INTERPOLATION_QUALITY;
		...
		/// <seealso cref= #KEY_ALPHA_INTERPOLATION </seealso>
		public static readonly Object VALUE_ALPHA_INTERPOLATION_DEFAULT = SunHints.VALUE_ALPHA_INTERPOLATION_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_COLOR_RENDERING = SunHints.KEY_COLOR_RENDERING;
		...
		public static readonly Object VALUE_COLOR_RENDER_SPEED = SunHints.VALUE_COLOR_RENDER_SPEED;

		/// <summary>
		/// Color rendering hint value -- perform the color conversion
		/// calculations with the highest accuracy and visual quality. </summary>
		/// <seealso cref= #KEY_COLOR_RENDERING </seealso>
		public static readonly Object VALUE_COLOR_RENDER_QUALITY = SunHints.VALUE_COLOR_RENDER_QUALITY;
		...
		/// accuracy. </summary>
		/// <seealso cref= #KEY_COLOR_RENDERING </seealso>
		public static readonly Object VALUE_COLOR_RENDER_DEFAULT = SunHints.VALUE_COLOR_RENDER_DEFAULT;
		...
		/// </para>
		/// </summary>
		public static readonly Key KEY_STROKE_CONTROL = SunHints.KEY_STROKE_CONTROL;
		...
		/// @since 1.3 </seealso>
		public static readonly Object VALUE_STROKE_DEFAULT = SunHints.VALUE_STROKE_DEFAULT;
		...
		/// <seealso cref= #KEY_STROKE_CONTROL
		/// @since 1.3 </seealso>
		public static readonly Object VALUE_STROKE_NORMALIZE = SunHints.VALUE_STROKE_NORMALIZE;
		...
		/// <seealso cref= #KEY_STROKE_CONTROL
		/// @since 1.3 </seealso>
		public static readonly Object VALUE_STROKE_PURE = SunHints.VALUE_STROKE_PURE;
		...
		public RenderingHints<T1>(IDictionary<T1> init)
		{
			if (init != java.util.Map_Fields.Null)
			{
				Hintmap.PutAll(init);
			}
		}
		...
		public virtual void Add(RenderingHints hints)
		{
		...
		public virtual void putAll<T1>(IDictionary<T1> m)
		{
			// ## javac bug?
			//if (m instanceof RenderingHints) {
			if (typeof(RenderingHints).IsInstanceOfType(m))
			{
				//hintmap.putAll(((RenderingHints) m).hintmap);
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: for (java.util.Map_Entry<?,?> entry : m.entrySet())
				foreach (java.util.Map_Entry<?, ?> entry in m)
				{
					Hintmap.Put(entry.Key, entry.Value);
				}
			}
			else
			{
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public Object clone()
		public virtual Object Clone()
		{
			...
			try
			{
				rh = (RenderingHints) base.Clone();
				if (Hintmap != java.util.Map_Fields.Null)
				{
					rh.Hintmap = (Dictionary<Object, Object>) Hintmap.Clone();
				}
			}
		...
		public override String ToString()
		{
			...
			{
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
				return this.GetType().FullName + "@" + HashCode().ToString("x") + " (0 hints)";
			}
