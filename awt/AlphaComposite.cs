...
namespace java.awt
{
	...
	public sealed class AlphaComposite : Composite
	{
		/// <summary>
...
//ORIGINAL LINE: @Native public static final int CLEAR = 1;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int SRC = 2;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int DST = 9;
		public const int DST = 9;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int SRC_OVER = 3;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int DST_OVER = 4;
		public const int DST_OVER = 4;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int SRC_IN = 5;
		public const int SRC_IN = 5;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int DST_IN = 6;
		public const int DST_IN = 6;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int SRC_OUT = 7;
		public const int SRC_OUT = 7;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int DST_OUT = 8;
		public const int DST_OUT = 8;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int SRC_ATOP = 10;
		public const int SRC_ATOP = 10;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int DST_ATOP = 11;
		public const int DST_ATOP = 11;
		...
		/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native public static final int XOR = 12;
		...
		public static readonly AlphaComposite Clear = new AlphaComposite(CLEAR);

		/// <summary>
		/// <code>AlphaComposite</code> object that implements the opaque SRC rule
		/// with an alpha of 1.0f. </summary>
		/// <seealso cref= #SRC </seealso>
		public static readonly AlphaComposite Src = new AlphaComposite(SRC);
		...
		/// @since 1.4 </seealso>
		public static readonly AlphaComposite SrcAtop = new AlphaComposite(SRC_ATOP);
		...
		/// @since 1.4 </seealso>
		public static readonly AlphaComposite DstAtop = new AlphaComposite(DST_ATOP);
		...
		/// <seealso cref= #XOR
		/// @since 1.4 </seealso>
		public static readonly AlphaComposite Xor = new AlphaComposite(XOR);

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native private static final int MIN_RULE = CLEAR;
		private const int MIN_RULE = CLEAR;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Native private static final int MAX_RULE = XOR;
		private const int MAX_RULE = XOR;

		internal float ExtraAlpha;
		internal int Rule_Renamed;

		private AlphaComposite(int rule) : this(rule, 1.0f)
		{
		}
		...
		{
			return (this.Rule_Renamed == rule) ? this : GetInstance(rule, this.ExtraAlpha);
		}
		...
		{
			return (this.ExtraAlpha == alpha) ? this : GetInstance(this.Rule_Renamed, alpha);
		}
		...
		public override bool Equals(Object obj)
		{
			...
			if (Rule_Renamed != ac.Rule_Renamed)
			{
				return false;
			}
