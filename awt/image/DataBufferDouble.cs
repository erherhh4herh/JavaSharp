...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	public sealed class DataBufferDouble : DataBuffer
	{
		...
		internal double[][] Bankdata;

		/// <summary>
		/// A reference to the default data bank. </summary>
		internal double[] Data_Renamed;
		...
		public DataBufferDouble(int size) : base(STABLE, TYPE_DOUBLE, size)
		{
			Data_Renamed = new double[size];
		...
		public DataBufferDouble(int size, int numBanks) : base(STABLE, TYPE_DOUBLE, size, numBanks)
		{
		...
		public DataBufferDouble(double[] dataArray, int size) : base(UNTRACKABLE, TYPE_DOUBLE, size)
		{
		...
		public DataBufferDouble(double[] dataArray, int size, int offset) : base(UNTRACKABLE, TYPE_DOUBLE, size, 1, offset)
		{
			Data_Renamed = dataArray;
			Bankdata = new double[1][];
			Bankdata[0] = Data_Renamed;
		...
		public DataBufferDouble(double[][] dataArray, int size) : base(UNTRACKABLE, TYPE_DOUBLE, size, dataArray.Length)
		{
		...
		public DataBufferDouble(double[][] dataArray, int size, int[] offsets) : base(UNTRACKABLE, TYPE_DOUBLE, size, dataArray.Length, offsets)
		{
			Bankdata = (double[][]) dataArray.clone();
			Data_Renamed = Bankdata[0];
		}
		...
		{
			Data_Renamed[i + Offset_Renamed] = (double)val;
		...
		{
			Bankdata[bank][i + Offsets_Renamed[bank]] = (double)val;
			TheTrackable.markDirty();
		}
		...
		{
			return (float)Data_Renamed[i + Offset_Renamed];
		}
		...
		{
			return (float)Bankdata[bank][i + Offsets_Renamed[bank]];
		}
