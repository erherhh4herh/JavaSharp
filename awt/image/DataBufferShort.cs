...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	public sealed class DataBufferShort : DataBuffer
	{
		...
		public DataBufferShort(int size) : base(STABLE, TYPE_SHORT,size)
		{
		...
		public DataBufferShort(int size, int numBanks) : base(STABLE, TYPE_SHORT,size,numBanks)
		{
		...
		public DataBufferShort(short[] dataArray, int size) : base(UNTRACKABLE, TYPE_SHORT, size)
		{
		...
		public DataBufferShort(short[] dataArray, int size, int offset) : base(UNTRACKABLE, TYPE_SHORT, size, 1, offset)
		{
			Data_Renamed = dataArray;
			Bankdata = new short[1][];
			Bankdata[0] = Data_Renamed;
		...
		/// <param name="size"> The size of the banks in the <CODE>DataBuffer</CODE>. </param>
		public DataBufferShort(short[][] dataArray, int size) : base(UNTRACKABLE, TYPE_SHORT, size, dataArray.Length)
		{
		...
		public DataBufferShort(short[][] dataArray, int size, int[] offsets) : base(UNTRACKABLE, TYPE_SHORT, size, dataArray.Length, offsets)
		{
			Bankdata = (short[][]) dataArray.clone();
			Data_Renamed = Bankdata[0];
		}
		...
		{
			Data_Renamed[i + Offset_Renamed] = (short)val;
		...
		{
			Bankdata[bank][i + Offsets_Renamed[bank]] = (short)val;
			TheTrackable.markDirty();
		}
	}
