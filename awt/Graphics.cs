...
namespace java.awt
{
	...
	public abstract class Graphics
	{
		...
		public virtual Graphics Create(int x, int y, int width, int height)
		{
			Graphics g = Create();
			if (g == null)
			{
		...
		public abstract Color XORMode {set;}
		...
		public virtual FontMetrics FontMetrics
		{
			get
			{
		...
		public abstract Rectangle ClipBounds {get;}
		...
		/// <seealso cref=         java.awt.Graphics#setClip(Shape)
		/// @since       JDK1.1 </seealso>
		public abstract Shape Clip {get;set;}
		...
		public virtual void Draw3DRect(int x, int y, int width, int height, bool raised)
		{
			Color c = Color;
		...
		public virtual void Fill3DRect(int x, int y, int width, int height, bool raised)
		{
			Color c = Color;
			Color brighter = c.Brighter();
			Color darker = c.Darker();
		...
		/// <seealso cref=          java.awt.Graphics#fillPolygon </seealso>
		/// <seealso cref=          java.awt.Graphics#drawPolyline </seealso>
		public virtual void DrawPolygon(Polygon p)
		{
		...
		/// <seealso cref=          java.awt.Graphics#drawPolygon(int[], int[], int) </seealso>
		public virtual void FillPolygon(Polygon p)
		{
	   ...
	   public abstract void DrawString(AttributedCharacterIterator iterator, int x, int y);
		...
		public virtual void DrawChars(char[] data, int offset, int length, int x, int y)
		{
		...
		/// <seealso cref=         java.awt.Graphics#drawChars </seealso>
		/// <seealso cref=         java.awt.Graphics#drawString </seealso>
		public virtual void DrawBytes(sbyte[] data, int offset, int length, int x, int y)
		{
			DrawString(StringHelperClass.NewString(data, 0, offset, length), x, y);
		}
		...
		/// <seealso cref=      java.awt.image.ImageObserver </seealso>
		/// <seealso cref=      java.awt.image.ImageObserver#imageUpdate(java.awt.Image, int, int, int, int, int) </seealso>
		public abstract bool DrawImage(Image img, int x, int y, int width, int height, ImageObserver observer);
		...
		/// <seealso cref=      java.awt.image.ImageObserver </seealso>
		/// <seealso cref=      java.awt.image.ImageObserver#imageUpdate(java.awt.Image, int, int, int, int, int) </seealso>
		public abstract bool DrawImage(Image img, int x, int y, int width, int height, Color bgcolor, ImageObserver observer);
		...
		/// @since       JDK1.1 </seealso>
		public abstract bool DrawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2, ImageObserver observer);
		...
		/// <seealso cref=         java.awt.image.ImageObserver#imageUpdate(java.awt.Image, int, int, int, int, int)
		/// @since       JDK1.1 </seealso>
		public abstract bool DrawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2, Color bgcolor, ImageObserver observer);
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
			return this.GetType().FullName + "[font=" + Font + ",color=" + Color + "]";
		}
		...
		///         otherwise. </returns>
		public virtual bool HitClip(int x, int y, int width, int height)
		{
			// Note, this implementation is not very efficient.
			// Subclasses should override this method and calculate
			// the results more directly.
			Rectangle clipRect = ClipBounds;
			if (clipRect == null)
			{
				return true;
			}
		...
		public virtual Rectangle GetClipBounds(Rectangle r)
		{
			// Note, this implementation is not very efficient.
			...
			if (clipRect != null)
			{
				r.x = clipRect.x;
				r.y = clipRect.y;
				r.Width_Renamed = clipRect.Width_Renamed;
				r.Height_Renamed = clipRect.Height_Renamed;
			}
			else if (r == null)
			{
