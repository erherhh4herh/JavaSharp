...
namespace java.awt.im
{
	...
	public class InputContext
	{
		...
		/// </summary>
		protected internal InputContext()
		{
		...
		public virtual bool SelectInputMethod(Locale locale)
		{
			// real implementation is in sun.awt.im.InputContext
			return false;
		}
		...
		public virtual Subset[] CharacterSubsets
		{
			set
			{
				// real implementation is in sun.awt.im.InputContext
		...
		/// @since 1.3 </seealso>
		public virtual bool CompositionEnabled
		{
			set
			{
				// real implementation is in sun.awt.im.InputContext
		...
		public virtual void RemoveNotify(Component client)
		{
			// real implementation is in sun.awt.im.InputContext
		}
		...
		public virtual Object InputMethodControlObject
		{
			get
			{
				// real implementation is in sun.awt.im.InputContext
