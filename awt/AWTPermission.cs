...
namespace java.awt
{
	...
	public sealed class AWTPermission : BasicPermission
	{

		/// <summary>
		/// use serialVersionUID from the Java 2 platform for interoperability </summary>
		private const long SerialVersionUID = 8890392402588814465L;
		...
		public AWTPermission(String name) : base(name)
		{
		}
		...
		public AWTPermission(String name, String actions) : base(name, actions)
		{
		}
	}
