...
namespace java.net
{
	...
	public sealed class NetPermission : BasicPermission
	{
		private const long SerialVersionUID = -8343910153355041693L;
		...
		public NetPermission(String name) : base(name)
		{
		}
		...
		public NetPermission(String name, String actions) : base(name, actions)
		{
		}
	}
