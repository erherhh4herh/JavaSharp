...
namespace java.nio
{
	...
	internal class DirectIntBufferS : IntBuffer, DirectBuffer
	{
		...
		//
		internal DirectIntBufferS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
