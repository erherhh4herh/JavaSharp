...
/// </table></blockquote>
/// 
/// <para> A <i>channel</i> represents an open connection to an entity such as a
...
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.Channel"/> interface is extended by several
/// other interfaces.
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.ReadableByteChannel"/> interface specifies a
...
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.ScatteringByteChannel"/> and {@link
...
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.NetworkChannel"/> interface specifies methods
...
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.Channels"/> utility class defines static methods
...
/// 
/// </para>
/// <para> The <seealso cref="java.nio.channels.FileChannel"/> class supports the usual
...
/// 
/// </para>
/// <para> A {@code FileChannel} is created by invoking one of its static {@link
...
/// </para>
/// <tr><th align="left">Multiplexed, non-blocking I/O</th><th align="left"><para>Description</th></tr>
...
/// 
/// </para>
/// <para> Multiplexed, non-blocking I/O, which is much more scalable than
/// thread-oriented, blocking I/O, is provided by <i>selectors</i>, <i>selectable
/// channels</i>, and <i>selection keys</i>.
/// 
/// </para>
/// <para> A <a href="Selector.html"><i>selector</i></a> is a multiplexor of <a
...
/// 
/// </para>
/// <para> Once some channels have been registered with a selector, a <a
...
/// 
/// </para>
/// <para> That a selection key indicates that its channel is ready for some operation
...
/// 
/// </para>
/// <para> This package defines selectable-channel classes corresponding to the {@link
...
/// 
/// </para>
/// <para> The implementation of selectors, selectable channels, and selection keys
...
/// 
/// </para>
/// <para> Much of the bookkeeping and synchronization required to implement the
...
/// 
/// </para>
/// <para> <seealso cref="java.nio.channels.AsynchronousChannel Asynchronous channels"/> are a
...
/// 
/// </para>
/// <para> This package defines asynchronous-channel classes that are connected to
...
/// 
/// </para>
/// <para> Asynchronous channels are bound to an asynchronous channel group for the
...
/// 
/// </para>
/// <para> As with selectors, the implementation of asynchronous channels can be
