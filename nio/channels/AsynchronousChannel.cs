...
namespace java.nio.channels
{
	...
	/// 
	/// <para> In the first form, the methods defined by the <seealso cref="Future Future"/>
	...
	/// 
	/// </para>
	/// <para> The {@code Future} interface defines the <seealso cref="Future#cancel cancel"/>
	...
	/// 
	/// </para>
	/// <para> Where the <seealso cref="Future#cancel cancel"/> method is invoked with the {@code
	...
	/// 
	/// </para>
	/// <para> Where the {@code cancel} method is invoked to cancel read or write
