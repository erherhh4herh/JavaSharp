...
namespace java.nio
{
	...
	internal class ByteBufferAsLongBufferB : LongBuffer // package-private
	{
		...
		internal ByteBufferAsLongBufferB(ByteBuffer bb) : base(-1, 0, bb.Remaining() >> 3, bb.Remaining() >> 3) // package-private
		{
		...
		internal ByteBufferAsLongBufferB(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap)
		{
