...
namespace java.nio
{
	...
	internal class ByteBufferAsShortBufferRL : ByteBufferAsShortBufferL // package-private
	{
		...
		internal ByteBufferAsShortBufferRL(ByteBuffer bb) : base(bb) // package-private
		{
		...
		internal ByteBufferAsShortBufferRL(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(bb, mark, pos, lim, cap, off)
		{
