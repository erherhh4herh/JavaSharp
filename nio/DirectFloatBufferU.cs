...
namespace java.nio
{
	...
	internal class DirectFloatBufferU : FloatBuffer, DirectBuffer
	{
		...
		//
		internal DirectFloatBufferU(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
