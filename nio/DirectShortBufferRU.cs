...
namespace java.nio
{
	...
	internal class DirectShortBufferRU : DirectShortBufferU, DirectBuffer
	{
		...
		//
		internal DirectShortBufferRU(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(db, mark, pos, lim, cap, off) // package-private
		{
