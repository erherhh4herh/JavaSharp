...
namespace java.nio
{
	...
	internal class DirectDoubleBufferU : DoubleBuffer, DirectBuffer
	{
		...
		//
		internal DirectDoubleBufferU(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
