...
namespace java.nio
{
	...
	internal class DirectLongBufferU : LongBuffer, DirectBuffer
	{
		...
		//
		internal DirectLongBufferU(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
