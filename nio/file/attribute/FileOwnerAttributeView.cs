...
namespace java.nio.file.attribute
{
	...
	/// created the file.
	/// 
	/// <para> The <seealso cref="#getOwner getOwner"/> or <seealso cref="#setOwner setOwner"/> methods may
	/// be used to read or update the owner of the file.
	/// 
	/// </para>
	/// <para> The <seealso cref="java.nio.file.Files#getAttribute getAttribute"/> and
	...
	public interface FileOwnerAttributeView : FileAttributeView
	{
		...
		/// Read the file owner.
		/// 
		/// <para> It it implementation specific if the file owner can be a {@link
...
//ORIGINAL LINE: UserPrincipal getOwner() throws java.io.IOException;
		...
		///          to a group </exception>
		/// <exception cref="SecurityException">
		///          In the case of the default provider, a security manager is
		///          installed, and it denies {@link
		///          RuntimePermission}<tt>("accessUserInformation")</tt> or its
		///          <seealso cref="SecurityManager#checkWrite(String) checkWrite"/> method
		///          denies write access to the file. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: void setOwner(UserPrincipal owner) throws java.io.IOException;
	}
