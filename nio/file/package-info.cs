...
/// 
/// <para> The java.nio.file package defines classes to access files and file
...
/// platform default provider, or to construct other provider implementations. </para>
/// 
/// <h3><a name="links">Symbolic Links</a></h3>
/// <para> Many operating systems and file systems support for <em>symbolic links</em>.
...
/// not included in this package. </para>
/// 
/// <h3><a name="interop">Interoperability</a></h3>
/// <para> The <seealso cref="java.io.File"/> class defines the {@link java.io.File#toPath
...
/// and {@code java.io.File} objects. </para>
/// 
/// <h3>Visibility</h3>
/// <para> The view of the files and file system provided by classes in this package are
...
/// system-dependent and are therefore unspecified. </para>
/// 
/// <h3><a name="integrity">Synchronized I/O File Integrity</a></h3>
/// <para> The <seealso cref="java.nio.file.StandardOpenOption#SYNC SYNC"/> and {@link
...
/// cause a {@code NullPointerException}, unless otherwise specified. </para>
/// 
/// <para> Unless otherwise noted, methods that attempt to access the file system
...
/// access. </para>
/// 
/// <para> Unless otherwise noted, invoking a method of any class or interface in
...
/// will throw <seealso cref="java.nio.file.ProviderMismatchException"/>. </para>
/// 
