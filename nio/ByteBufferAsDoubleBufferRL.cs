...
namespace java.nio
{
	...
	internal class ByteBufferAsDoubleBufferRL : ByteBufferAsDoubleBufferL // package-private
	{
		...
		internal ByteBufferAsDoubleBufferRL(ByteBuffer bb) : base(bb) // package-private
		{
		...
		internal ByteBufferAsDoubleBufferRL(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(bb, mark, pos, lim, cap, off)
		{
