...
namespace java.nio
{
	...
	internal class DirectIntBufferRS : DirectIntBufferS, DirectBuffer
	{
		...
		//
		internal DirectIntBufferRS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(db, mark, pos, lim, cap, off) // package-private
		{
