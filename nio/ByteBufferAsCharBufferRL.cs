...
namespace java.nio
{
	...
	internal class ByteBufferAsCharBufferRL : ByteBufferAsCharBufferL // package-private
	{
		...
		internal ByteBufferAsCharBufferRL(ByteBuffer bb) : base(bb) // package-private
		{
		...
		internal ByteBufferAsCharBufferRL(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(bb, mark, pos, lim, cap, off)
		{
