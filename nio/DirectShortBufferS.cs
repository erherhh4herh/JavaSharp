...
namespace java.nio
{
	...
	internal class DirectShortBufferS : ShortBuffer, DirectBuffer
	{
		...
		//
		internal DirectShortBufferS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
