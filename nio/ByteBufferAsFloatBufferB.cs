...
namespace java.nio
{
	...
	internal class ByteBufferAsFloatBufferB : FloatBuffer // package-private
	{
		...
		internal ByteBufferAsFloatBufferB(ByteBuffer bb) : base(-1, 0, bb.Remaining() >> 2, bb.Remaining() >> 2) // package-private
		{
		...
		internal ByteBufferAsFloatBufferB(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap)
		{
