...
namespace java.nio
{
	...
	internal class DirectDoubleBufferRS : DirectDoubleBufferS, DirectBuffer
	{
		...
		//
		internal DirectDoubleBufferRS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(db, mark, pos, lim, cap, off) // package-private
		{
