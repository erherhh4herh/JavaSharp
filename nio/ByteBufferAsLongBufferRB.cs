...
namespace java.nio
{
	...
	internal class ByteBufferAsLongBufferRB : ByteBufferAsLongBufferB // package-private
	{
		...
		internal ByteBufferAsLongBufferRB(ByteBuffer bb) : base(bb) // package-private
		{
		...
		internal ByteBufferAsLongBufferRB(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(bb, mark, pos, lim, cap, off)
		{
