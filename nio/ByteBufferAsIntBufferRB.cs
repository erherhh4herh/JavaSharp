...
namespace java.nio
{
	...
	internal class ByteBufferAsIntBufferRB : ByteBufferAsIntBufferB // package-private
	{
		...
		internal ByteBufferAsIntBufferRB(ByteBuffer bb) : base(bb) // package-private
		{
		...
		internal ByteBufferAsIntBufferRB(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(bb, mark, pos, lim, cap, off)
		{
