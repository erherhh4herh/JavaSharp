...
namespace java.nio
{
	...
	internal class DirectCharBufferRS : DirectCharBufferS, DirectBuffer
	{
		...
		//
		internal DirectCharBufferRS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(db, mark, pos, lim, cap, off) // package-private
		{
