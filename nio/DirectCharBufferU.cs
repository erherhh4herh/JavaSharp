...
namespace java.nio
{
	...
	internal class DirectCharBufferU : CharBuffer, DirectBuffer
	{
		...
		//
		internal DirectCharBufferU(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap) // package-private
		{
