...
namespace java.nio
{
	...
	internal class DirectFloatBufferRS : DirectFloatBufferS, DirectBuffer
	{
		...
		//
		internal DirectFloatBufferRS(DirectBuffer db, int mark, int pos, int lim, int cap, int off) : base(db, mark, pos, lim, cap, off) // package-private
		{
