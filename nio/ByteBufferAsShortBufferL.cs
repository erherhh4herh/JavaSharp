...
namespace java.nio
{
	...
	internal class ByteBufferAsShortBufferL : ShortBuffer // package-private
	{
		...
		internal ByteBufferAsShortBufferL(ByteBuffer bb) : base(-1, 0, bb.Remaining() >> 1, bb.Remaining() >> 1) // package-private
		{
		...
		internal ByteBufferAsShortBufferL(ByteBuffer bb, int mark, int pos, int lim, int cap, int off) : base(mark, pos, lim, cap)
		{
