...
namespace java.io
{
	...
	public class RandomAccessFile : DataOutput, DataInput, Closeable
	{
		...
		private const int O_RDONLY = 1;
		private const int O_RDWR = 2;
		private const int O_SYNC = 4;
		private const int O_DSYNC = 8;
		...
		/// 
		/// <para> The <tt>mode</tt> argument specifies the access mode with which the
...
//ORIGINAL LINE: public RandomAccessFile(String name, String mode) throws FileNotFoundException
		public RandomAccessFile(String name, String mode) : this(name != null ? new File(name) : null, mode)
		{
		}
		...
		/// 
		/// <para>The <a name="mode"><tt>mode</tt></a> argument specifies the access mode
		...
		/// 
		/// </para>
		/// <para>The <tt>"rwd"</tt> mode can be used to reduce the number of I/O
		...
		/// 
		/// </para>
		/// <para>If there is a security manager, its {@code checkRead} method is
		...
		/// @spec JSR-51 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public RandomAccessFile(File file, String mode) throws FileNotFoundException
...
//ORIGINAL LINE: public final FileDescriptor getFD() throws IOException
		...
		/// 
		/// <para> The {@link java.nio.channels.FileChannel#position()
		...
		public FileChannel Channel
		{
			get
			{
				lock (this)
				{
					...
					{
						Channel_Renamed = FileChannelImpl.open(Fd, Path, true, Rw, this);
					}
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		private extern void open0(String name, int mode);
		...
		///             defined above </param>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private void open(String name, int mode) throws FileNotFoundException
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		private extern void write0(int b);
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		private extern void writeBytes(sbyte[] b, int off, int len);
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public extern long getFilePointer();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void seek(long pos) throws IOException
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		private extern void seek0(long pos);
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public extern void setLength(long newLength);
...
//ORIGINAL LINE: public void close() throws IOException
		...
		{
			private readonly RandomAccessFile OuterInstance;

			public CloseableAnonymousInnerClassHelper(RandomAccessFile outerInstance)
			{
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public final String readLine() throws IOException
...
//ORIGINAL LINE: public final void writeShort(int v) throws IOException
		...
		{
			Write(((int)((uint)v >> 8)) & 0xFF);
			Write(((int)((uint)v >> 0)) & 0xFF);
			//written += 2;
		}
...
//ORIGINAL LINE: public final void writeInt(int v) throws IOException
		...
		{
			Write(((int)((uint)v >> 24)) & 0xFF);
			Write(((int)((uint)v >> 16)) & 0xFF);
			Write(((int)((uint)v >> 8)) & 0xFF);
			Write(((int)((uint)v >> 0)) & 0xFF);
			//written += 4;
		}
...
//ORIGINAL LINE: public final void writeLong(long v) throws IOException
		...
		{
			Write((int)((long)((ulong)v >> 56)) & 0xFF);
			Write((int)((long)((ulong)v >> 48)) & 0xFF);
			Write((int)((long)((ulong)v >> 40)) & 0xFF);
			Write((int)((long)((ulong)v >> 32)) & 0xFF);
			Write((int)((long)((ulong)v >> 24)) & 0xFF);
			Write((int)((long)((ulong)v >> 16)) & 0xFF);
			Write((int)((long)((ulong)v >> 8)) & 0xFF);
			Write((int)((long)((ulong)v >> 0)) & 0xFF);
			//written += 8;
		}
...
//ORIGINAL LINE: @SuppressWarnings("deprecation") public final void writeBytes(String s) throws IOException
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
...
//ORIGINAL LINE: public final void writeChars(String s) throws IOException
		public void WriteChars(String s)
		{
			...
			{
				b[j++] = (sbyte)((int)((uint)c[i] >> 8));
				b[j++] = (sbyte)((int)((uint)c[i] >> 0));
			}
			writeBytes(b, 0, blen);
		}
