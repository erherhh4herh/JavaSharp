...
//ORIGINAL LINE: long length() throws SQLException;
	  ...
	  /// @since 1.2 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: String getSubString(long pos, int length) throws SQLException;
...
//ORIGINAL LINE: java.io.Reader getCharacterStream() throws SQLException;
	  ...
	  /// @since 1.2 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: java.io.InputStream getAsciiStream() throws SQLException;
	  ...
	  /// @since 1.2 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: long position(String searchstr, long start) throws SQLException;
	  ...
	  /// @since 1.2 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: long position(Clob searchstr, long start) throws SQLException;
	  long Position(Clob searchstr, long start);
		...
		/// @since 1.4 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: int setString(long pos, String str) throws SQLException;
		...
		/// @since 1.4 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: int setString(long pos, String str, int offset, int len) throws SQLException;
		...
		/// @since 1.4 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: java.io.OutputStream setAsciiStream(long pos) throws SQLException;
		...
		/// @since 1.4 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: java.io.Writer setCharacterStream(long pos) throws SQLException;
...
//ORIGINAL LINE: void free() throws SQLException;
		...
		/// @since 1.6 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: java.io.Reader getCharacterStream(long pos, long length) throws SQLException;
