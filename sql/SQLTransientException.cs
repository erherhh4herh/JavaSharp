...
namespace java.sql
{
	...
	public class SQLTransientException : java.sql.SQLException
	{
			...
			/// </para>
			/// </summary>
			public SQLTransientException() : base()
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientException(String reason) : base(reason)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientException(String reason, String SQLState) : base(reason,SQLState)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientException(String reason, String SQLState, int vendorCode) : base(reason,SQLState,vendorCode)
			{
			}
		...
		/// @since 1.6 </param>
		public SQLTransientException(Throwable cause) : base(cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientException(String reason, Throwable cause) : base(reason,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientException(String reason, String SQLState, Throwable cause) : base(reason,SQLState,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientException(String reason, String SQLState, int vendorCode, Throwable cause) : base(reason,SQLState,vendorCode,cause)
		{
		}

		private new const long SerialVersionUID = -9042733978262274539L;
	}
