...
namespace java.sql
{
	...
	/// </para>
	/// </summary>
	public class SQLTransientConnectionException : java.sql.SQLTransientException
	{
			...
			/// </para>
			/// </summary>
			public SQLTransientConnectionException() : base()
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientConnectionException(String reason) : base(reason)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientConnectionException(String reason, String SQLState) : base(reason,SQLState)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLTransientConnectionException(String reason, String SQLState, int vendorCode) : base(reason,SQLState,vendorCode)
			{
			}
	   ...
	   /// @since 1.6 </param>
		public SQLTransientConnectionException(Throwable cause) : base(cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientConnectionException(String reason, Throwable cause) : base(reason,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientConnectionException(String reason, String SQLState, Throwable cause) : base(reason,SQLState,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLTransientConnectionException(String reason, String SQLState, int vendorCode, Throwable cause) : base(reason,SQLState,vendorCode,cause)
		{
		}

		private new const long SerialVersionUID = -2520155553543391200L;
	}
