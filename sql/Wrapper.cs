...
//ORIGINAL LINE: <T> T unwrap(Class iface) throws java.sql.SQLException;
			T unwrap<T>(Class iface);
		...
		/// @since 1.6 </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: boolean isWrapperFor(Class iface) throws java.sql.SQLException;
		bool IsWrapperFor(Class iface);
