...
namespace java.sql
{
	...
	/// </para>
	/// </summary>
	public class SQLNonTransientConnectionException : java.sql.SQLNonTransientException
	{
			...
			/// </para>
			/// </summary>
			public SQLNonTransientConnectionException() : base()
			{
			}
			...
			/// @since 1.6 </param>
			public SQLNonTransientConnectionException(String reason) : base(reason)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLNonTransientConnectionException(String reason, String SQLState) : base(reason,SQLState)
			{
			}
			...
			/// @since 1.6 </param>
			public SQLNonTransientConnectionException(String reason, String SQLState, int vendorCode) : base(reason,SQLState,vendorCode)
			{
			}
			...
			/// @since 1.6 </param>
		public SQLNonTransientConnectionException(Throwable cause) : base(cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLNonTransientConnectionException(String reason, Throwable cause) : base(reason,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLNonTransientConnectionException(String reason, String SQLState, Throwable cause) : base(reason,SQLState,cause)
		{
		}
		...
		///     the cause is non-existent or unknown.
		/// @since 1.6 </param>
		public SQLNonTransientConnectionException(String reason, String SQLState, int vendorCode, Throwable cause) : base(reason,SQLState,vendorCode,cause)
		{
		}

		private new const long SerialVersionUID = -5852318857474782892L;
