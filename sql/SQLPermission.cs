...
namespace java.sql
{
	...
	public sealed class SQLPermission : BasicPermission
	{
		...
		public SQLPermission(String name) : base(name)
		{
		}
		...
		public SQLPermission(String name, String actions) : base(name, actions)
		{
		}
		...
		/// compatibility.
		/// </summary>
		internal const long SerialVersionUID = -1439323187199563495L;
