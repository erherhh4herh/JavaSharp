...
namespace java.util.spi
{
	...
	public abstract class LocaleServiceProvider
	{
		...
		/// implicit.)
		/// </summary>
		protected internal LocaleServiceProvider()
		{
		}
		...
		/// 
		/// <para>The array returned by this method should not include two or more
		...
		public abstract Locale[] AvailableLocales {get;}
