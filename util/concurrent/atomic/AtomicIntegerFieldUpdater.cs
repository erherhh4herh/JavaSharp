...
//ORIGINAL LINE: @CallerSensitive public static <U> AtomicIntegerFieldUpdater<U> newUpdater(Class tclass, String fieldName)
		public static AtomicIntegerFieldUpdater<U> newUpdater<U>(Class tclass, String fieldName)
		{
			return new AtomicIntegerFieldUpdaterImpl<U> (tclass, fieldName, Reflection.CallerClass);
		}

		/// <summary>
		/// Protected do-nothing constructor for use by subclasses.
		/// </summary>
		protected internal AtomicIntegerFieldUpdater()
		{
		}
		...
		public abstract bool CompareAndSet(T obj, int expect, int update);
		...
		/// <exception cref="ClassCastException"> if {@code obj} is not an instance
		/// of the class possessing the field established in the constructor </exception>
		public abstract bool WeakCompareAndSet(T obj, int expect, int update);
		...
		public virtual int GetAndSet(T obj, int newValue)
		{
			int prev;
			do
			{
		...
		/// <param name="obj"> An object whose field to get and set </param>
		/// <returns> the previous value </returns>
		public virtual int GetAndIncrement(T obj)
		{
			int prev, next;
			do
			{
		...
		/// <param name="obj"> An object whose field to get and set </param>
		/// <returns> the previous value </returns>
		public virtual int GetAndDecrement(T obj)
		{
			int prev, next;
			do
			{
		...
		/// <returns> the previous value </returns>
		public virtual int GetAndAdd(T obj, int delta)
		{
			int prev, next;
			do
			{
		...
		public virtual int IncrementAndGet(T obj)
		{
			int prev, next;
			do
			{
		...
		/// <param name="obj"> An object whose field to get and set </param>
		/// <returns> the updated value </returns>
		public virtual int DecrementAndGet(T obj)
		{
			int prev, next;
			do
			{
		...
		/// <param name="delta"> the value to add </param>
		/// <returns> the updated value </returns>
		public virtual int AddAndGet(T obj, int delta)
		{
			int prev, next;
			do
			{
		...
		/// @since 1.8 </returns>
		public int UpdateAndGet(T obj, IntUnaryOperator updateFunction)
		{
			int prev, next;
			do
			{
		...
		/// <returns> the updated value
		/// @since 1.8 </returns>
		public int AccumulateAndGet(T obj, int x, IntBinaryOperator accumulatorFunction)
		{
			int prev, next;
			do
			{
		...
		/// </summary>
		private class AtomicIntegerFieldUpdaterImpl<T> : AtomicIntegerFieldUpdater<T>
		{
...
//ORIGINAL LINE: AtomicIntegerFieldUpdaterImpl(final Class tclass, final String fieldName, final Class caller)
			internal AtomicIntegerFieldUpdaterImpl(Class tclass, String fieldName, Class caller)
			{
...
//ORIGINAL LINE: final int modifiers;
			...
			{
				private readonly AtomicIntegerFieldUpdaterImpl<T> OuterInstance;

				private Type Tclass;
				private string FieldName;

				public PrivilegedExceptionActionAnonymousInnerClassHelper(AtomicIntegerFieldUpdaterImpl<T> outerInstance, Type tclass, string fieldName)
				{
...
//ORIGINAL LINE: public Field run() throws NoSuchFieldException
			...
			public virtual bool CompareAndSet(T obj, int expect, int update)
			{
			...
			public virtual bool WeakCompareAndSet(T obj, int expect, int update)
			{
				if (obj == null || obj.GetType() != Tclass || Cclass != null)
				{
					FullCheck(obj);
			...
			public virtual void Set(T obj, int newValue)
			{
				if (obj == null || obj.GetType() != Tclass || Cclass != null)
				{
					FullCheck(obj);
			...
			public virtual void LazySet(T obj, int newValue)
			{
				if (obj == null || obj.GetType() != Tclass || Cclass != null)
				{
					FullCheck(obj);
