...
/// 
/// <para>This method (which varies in argument types across different
...
/// 
/// </para>
/// <para>The specifications of these methods enable implementations to
...
/// 
/// </para>
/// <para>It is straightforward to define new utility functions that, like
...
/// 
/// </para>
/// <para>The memory effects for accesses and updates of atomics generally
...
/// 
/// </para>
/// <para>In addition to classes representing single values, this package
...
/// 
/// </para>
/// <para>The <seealso cref="java.util.concurrent.atomic.AtomicMarkableReference"/>
...
/// 
/// </para>
/// <para>Atomic classes are designed primarily as building blocks for
...
/// 
/// </para>
/// <para>Atomic classes are not general purpose replacements for
