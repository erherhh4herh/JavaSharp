...
//ORIGINAL LINE: @SuppressWarnings("serial") abstract class Striped64 extends Number
	...
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @sun.misc.Contended static final class Cell
		internal sealed class Cell
		{
			internal volatile long Value;
			internal Cell(long x)
			{
				Value = x;
			}
			internal bool Cas(long cmp, long val)
			{
		...
		/// </summary>
		[NonSerialized]
		internal volatile int CellsBusy;
		...
		private static readonly long BASE;
