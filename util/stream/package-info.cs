...
/// }</pre>
/// 
/// <para>Here we use {@code widgets}, a {@code Collection<Widget>},
...
/// 
/// </para>
/// <para>The key abstraction introduced in this package is <em>stream</em>.  The
...
/// 
/// </para>
/// <para>Additional stream sources can be provided by third-party libraries using
/// <a href="package-summary.html#StreamSources">these techniques</a>.
/// 
/// <h2><a name="StreamOps">Stream operations and pipelines</a></h2>
/// 
/// </para>
/// <para>Stream operations are divided into <em>intermediate</em> and
...
/// 
/// </para>
/// <para>Intermediate operations return a new stream.  They are always
...
/// 
/// </para>
/// <para>Terminal operations, such as {@code Stream.forEach} or
...
/// 
/// </para>
/// <para> Processing streams lazily allows for significant efficiencies; in a
...
/// 
/// </para>
/// <para>Intermediate operations are further divided into <em>stateless</em>
...
/// 
/// </para>
/// <para>Stateful operations may need to process the entire input
...
/// 
/// </para>
/// <para>Further, some operations are deemed <em>short-circuiting</em> operations.
...
/// 
/// </para>
/// <para>Processing elements with an explicit {@code for-}loop is inherently serial.
...
/// 
/// </para>
/// <para>The only difference between the serial and parallel versions of this
...
/// 
/// </para>
/// <para>Except for operations identified as explicitly nondeterministic, such
...
/// 
/// </para>
/// <para>Accordingly, behavioral parameters in stream pipelines whose source might
...
/// 
/// </para>
/// <para>Note also that attempting to access mutable state from behavioral parameters
...
/// 
/// </para>
/// <para>If the behavioral parameters do have side-effects, unless explicitly
...
/// 
/// </para>
/// <para>Many computations where one might be tempted to use side effects can be more
...
/// 
/// </para>
/// <para>As an example of how to transform a stream pipeline that inappropriately
...
/// 
/// </para>
/// <para>Streams may or may not have a defined <em>encounter order</em>.  Whether
...
/// 
/// </para>
/// <para>If a stream is ordered, most operations are constrained to operate on the
...
/// 
/// </para>
/// <para>For sequential streams, the presence or absence of an encounter order does
...
/// 
/// </para>
/// <para>For parallel streams, relaxing the ordering constraint can sometimes enable
...
/// 
/// </para>
/// <para>Of course, such operations can be readily implemented as simple sequential
/// loops, as in:
/// <pre>{@code
///    int sum = 0;
///    for (int x : numbers) {
...
/// 
/// </para>
/// <para>These reduction operations can run safely in parallel with almost no
/// modification:
/// <pre>{@code
...
/// 
/// </para>
/// <para>Reduction parallellizes well because the implementation
...
/// 
/// </para>
/// <para>The "widgets" examples shown earlier shows how reduction combines with
...
/// 
/// </para>
/// <para>In its more general form, a {@code reduce} operation on elements of type
...
/// 
/// </para>
/// <para>More formally, the {@code identity} value must be an <em>identity</em> for
...
/// 
/// </para>
/// <para>The three-argument form is a generalization of the two-argument form,
...
/// 
/// </para>
/// <para>If we wanted to take a stream of strings and concatenate them into a
...
/// 
/// </para>
/// <para>We would get the desired result, and it would even work in parallel.  However,
...
/// 
/// </para>
/// <para>The mutable reduction operation is called
...
/// }</pre>
/// </para>
/// <para>As with {@code reduce()}, a benefit of expressing {@code collect} in this
...
/// 
/// </para>
/// <para>The three aspects of {@code collect} -- supplier, accumulator, and
...
/// 
/// </para>
/// <para>Packaging mutable reductions into a Collector has another advantage:
...
/// 
/// </para>
/// <para>As with the regular reduction operation, {@code collect()} operations can
...
/// 
/// </para>
/// <para>Further, however the computation is split, it must produce an equivalent
...
/// 
/// </para>
/// <para>Here, equivalence generally means according to <seealso cref="java.lang.Object#equals(Object)"/>.
...
/// 
/// </para>
/// <para>Suppose, however, that the result container used in this reduction
...
/// 
/// </para>
/// <para>A <seealso cref="java.util.stream.Collector"/> that supports concurrent reduction is
...
/// 
/// </para>
/// <para>Note that if it is important that the elements for a given key appear in
...
/// 
/// </para>
/// <para>Examples of associative operations include numeric addition, min, and
...
/// 
/// </para>
/// <para>The class <seealso cref="java.util.stream.StreamSupport"/> has a number of
...
/// 
/// </para>
/// <para>There are a number of implementation choices in implementing a
...
/// 
/// </para>
/// <para>A higher-quality spliterator will provide balanced and known-size
...
/// 
/// </para>
/// <para>Spliterators for mutable data sources have an additional challenge;
...
/// 
/// </para>
/// <para>These requirements significantly reduce the scope of potential
