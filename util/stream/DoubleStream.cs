...
namespace java.util.stream
{
	...
	public interface DoubleStream : BaseStream<Double, DoubleStream>
	{
		...
		///               function to apply to each element </param>
		/// <returns> the new stream </returns>
		Stream<U> mapToObj<U, T1>(DoubleFunction<T1> mapper) where T1 : U;
		...
		DoubleStream flatMap<T1>(DoubleFunction<T1> mapper) where T1 : DoubleStream;
		...
		/// }</pre>
		/// 
		/// <para>Like <seealso cref="#reduce(double, DoubleBinaryOperator)"/>, {@code collect}
		...
		R collect<R>(Supplier<R> supplier, ObjDoubleConsumer<R> accumulator, BiConsumer<R, R> combiner);
		...
		/// done by this method.
		/// 
		/// <para>If any stream element is a NaN or the sum is at any point a NaN
		...
		/// 
		/// </para>
		///  <para>The average is a special case of a <a
		...
		bool AnyMatch(DoublePredicate predicate);
		...
		bool AllMatch(DoublePredicate predicate);
		...
		/// provided predicate or the stream is empty, otherwise {@code false} </returns>
		bool NoneMatch(DoublePredicate predicate);
		...
		java.util.PrimitiveIterator_OfDouble Iterator();

		java.util.Spliterator_OfDouble Spliterator();
...
//		public static DoubleStream_Builder builder()
	//	{
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//		public static DoubleStream of(double DoubleStream_Fields.t)
	//	{
...
//		public static DoubleStream of(double... values)
	...
	//	}
		...
		/// {@code f(f(seed))}, etc.
		/// 
		/// <para>The first element (position {@code 0}) in the {@code DoubleStream}
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//		public static DoubleStream iterate(final double seed, final java.util.function.DoubleUnaryOperator f)
	//	{
...
//		public static DoubleStream concat(DoubleStream a, DoubleStream b)
	...
	public static class DoubleStream_Fields
	{
				public static readonly double t = seed;
					public static readonly return True;
					public static readonly double v = t;
					public static readonly return v;
			public static readonly java.util.Spliterator_OfDouble Split = new Streams.ConcatSpliterator.OfDouble(a.spliterator(), b.spliterator());
			public static readonly DoubleStream Stream = StreamSupport.DoubleStream(Split, a.Parallel || b.Parallel);
	}

	public interface DoubleStream_Builder : DoubleConsumer
	{
		...
		void Accept(double DoubleStream_Fields);
...
//		default DoubleStream_Builder add(double DoubleStream_Fields.t)
	//	{
	//		accept(DoubleStream_Fields.t);
	//	}
	...
	public static class DoubleStream_Builder_Fields
	{
