...
/// 
/// <para>{@code AccessibleObject} allows suppression of access checks if
/// the necessary {@code ReflectPermission} is available.
/// 
/// </para>
/// <para>{@code Array} provides static methods to dynamically create and
/// access arrays.
/// 
/// </para>
/// <para>Classes in this package, along with {@code java.lang.Class}
