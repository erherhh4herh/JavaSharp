...
namespace java.lang
{
	...
	using FpUtils = sun.misc.FpUtils;
	...
	/// </para>
	/// </summary>
	public sealed class Double : Number, Comparable<Double>
	{
		/// <summary>
		...
		/// </summary>
		public static readonly double NaN_Renamed = 0.0d / 0.0;
		...
		/// </summary>
		public static readonly double MAX_VALUE = 0x1.fffffffffffffP + 1023; // 1.7976931348623157e+308
		...
		/// @since 1.6
		/// </summary>
		public static readonly double MIN_NORMAL = 0x1.0p - 1022; // 2.2250738585072014E-308
		...
		/// </summary>
		public static readonly double MIN_VALUE = 0x0.0000000000001P - 1022; // 4.9e-324
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public static final Class TYPE = (Class) Class.getPrimitiveClass("double");
		public static readonly Class TYPE = (Class) Class.getPrimitiveClass("double");
		...
		public static String ToHexString(double d)
		{
			...
			else
			{
				...
				{
					bool subnormal = (d < DoubleConsts.MIN_NORMAL);
					...
					// trailing zeros.
					String signif = signifBits.ToString("x").Substring(3, 13);
					answer.Append(signif.Equals("0000000000000") ? "0": signif.ReplaceFirst("0{1,12}$", "")); // 13 zeros
		...
		/// {@code s}.
		/// 
		/// <para>If {@code s} is {@code null}, then a
		/// {@code NullPointerException} is thrown.
		/// 
		/// </para>
		/// <para>Leading and trailing whitespace characters in {@code s}
...
//ORIGINAL LINE: public static Double valueOf(String s) throws NumberFormatException
		...
		/// @since 1.2 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static double parseDouble(String s) throws NumberFormatException
		...
		{
			return System.Math.Abs(d) <= DoubleConsts.MAX_VALUE;
		}
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Double(String s) throws NumberFormatException
		...
		/// 
		/// <para>Note that in most cases, for two instances of class
		...
		/// 
		/// </para>
		/// <para>also has the value {@code true}. However, there are two
		/// exceptions:
		/// <ul>
		...
		{
			return (obj is Double) && (DoubleToLongBits(((Double)obj).Value) == DoubleToLongBits(Value));
		}
		...
		/// 
		/// </para>
		/// <para>In all cases, the result is a {@code long} integer that, when
		...
		/// 
		/// </para>
		/// <para>If the argument is NaN, the result is the {@code long}
		...
		/// 
		/// </para>
		/// <para>In all cases, the result is a {@code long} integer that,
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public static extern long doubleToRawLongBits(double value);
		...
		/// 
		/// <para>If the argument is {@code 0x7ff0000000000000L}, the result
		/// is positive infinity.
		/// 
		/// </para>
		/// <para>If the argument is {@code 0xfff0000000000000L}, the result
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public static extern double longBitsToDouble(long bits);
		...
		{
			return Value.CompareTo(anotherDouble.Value);
		}
		...
		public static int Compare(double d1, double d2)
		{
			...
			return (thisBits == anotherBits ? 0 : (thisBits < anotherBits ? - 1 : 1)); // (0.0, -0.0) or (NaN, !NaN) -  (-0.0, 0.0) or (!NaN, NaN) -  Values are equal
		}
		...
		private const long SerialVersionUID = -9172774392245257468L;
	}
