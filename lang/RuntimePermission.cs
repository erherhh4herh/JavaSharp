...
namespace java.lang
{
	...
	public sealed class RuntimePermission : BasicPermission
	{

		private const long SerialVersionUID = 7399184964622342223L;
		...
		public RuntimePermission(String name) : base(name)
		{
		}
		...
		public RuntimePermission(String name, String actions) : base(name, actions)
		{
		}
	}
