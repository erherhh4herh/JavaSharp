...
namespace java.lang
{
	...
	/// @author Josh Bloch
	/// </summary>
	internal class AssertionStatusDirectives
	{
		/// <summary>
		...
		/// 
		/// <para>In the case of conflicting directives for the same class, the
