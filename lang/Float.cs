...
namespace java.lang
{
	...
	/// </para>
	/// </summary>
	public sealed class Float : Number, Comparable<Float>
	{
		/// <summary>
		...
		/// </summary>
		public static readonly float NaN_Renamed = 0.0f / 0.0f;
		...
		/// </summary>
		public static readonly float MAX_VALUE = 0x1.fffffeP + 127f; // 3.4028235e+38f
		...
		/// @since 1.6
		/// </summary>
		public static readonly float MIN_NORMAL = 0x1.0p - 126f; // 1.17549435E-38f
		...
		/// </summary>
		public static readonly float MIN_VALUE = 0x0.000002P - 126f; // 1.4e-45f
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public static final Class TYPE = (Class) Class.getPrimitiveClass("float");
		public static readonly Class TYPE = (Class) Class.getPrimitiveClass("float");
		...
		{
			if (System.Math.Abs(f) < FloatConsts.MIN_NORMAL && f != 0.0f) // float subnormal
			{
...
//ORIGINAL LINE: public static Float valueOf(String s) throws NumberFormatException
		...
		/// @since 1.2 </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public static float parseFloat(String s) throws NumberFormatException
		...
		/// @since 1.8 </returns>
		 ...
		 {
			return System.Math.Abs(f) <= FloatConsts.MAX_VALUE;
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Float(String s) throws NumberFormatException
		...
		/// 
		/// </para>
		/// <para>also has the value {@code true}. However, there are two exceptions:
		/// <ul>
		...
		{
			return (obj is Float) && (FloatToIntBits(((Float)obj).Value) == FloatToIntBits(Value));
		}
		...
		/// 
		/// </para>
		/// <para>If the argument is NaN, the result is {@code 0x7fc00000}.
		/// 
		/// </para>
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public static extern int floatToRawIntBits(float value);
		...
		/// 
		/// <para>If the argument is {@code 0x7f800000}, the result is positive
		/// infinity.
		/// 
		/// </para>
		/// <para>If the argument is {@code 0xff800000}, the result is negative
		/// infinity.
		/// 
		/// </para>
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public static extern float intBitsToFloat(int bits);
		...
		{
			return Value.CompareTo(anotherFloat.Value);
		}
		...
		private const long SerialVersionUID = -2671257302660747028L;
	}
