...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		/// 
		/// <para><b>The actual result type is {@code Class<? extends |X|>}
		/// where {@code |X|} is the erasure of the static type of the
		/// expression on which {@code getClass} is called.</b> For
		/// example, no cast is required in this code fragment:</para>
		/// 
		/// <para>
		/// {@code Number n = 0;                             }<br>
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public final extern Class getClass();
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		protected internal extern Object clone();
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public final extern void notify();
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public final extern void notifyAll();
		...
		/// 
		/// </para>
		/// <para>If the current thread is {@link java.lang.Thread#interrupt()
...
//JAVA TO C# CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		[DllImport("unknown")]
		public final extern void wait(long timeout);
...
//ORIGINAL LINE: public final void wait(long timeout, int nanos) throws InterruptedException
		...
		/// <seealso cref=        java.lang.Object#notifyAll() </seealso>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public final void wait() throws InterruptedException
		public void Wait()
		{
