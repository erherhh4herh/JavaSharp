...
namespace java.lang.invoke
{
	...
	/// <summary>
	/// <para>Methods to facilitate the creation of simple "function objects" that
	...
	/// 
	/// </para>
	/// <para>Indirect access to the behavior specified by the provided {@code MethodHandle}
	...
	/// 
	/// </para>
	/// <para>It is sometimes useful to restrict the set of inputs or results permitted
	...
	/// 
	/// </para>
	/// <para>This class provides two forms of linkage methods: a standard version
	...
	/// 
	/// </para>
	/// <para>Assume the linkage arguments are as follows:
	/// <ul>
	...
	/// 
	/// </para>
	/// <para>Then the following linkage invariants must hold:
	/// <ul>
	...
	/// 
	/// </para>
	/// <para>Further, at capture time, if {@code implMethod} corresponds to an instance
	/// method, and there are any capture arguments ({@code K > 0}), then the first
	/// capture argument (corresponding to the receiver) must be non-null.
	/// 
	/// </para>
	/// <para>A type Q is considered adaptable to S as follows:
	...
	/// 
	/// </para>
	/// <para>The argument list of the implementation method and the argument list of
	...
	/// 
	/// </para>
	/// <para>Invokedynamic call sites have two argument lists: a static argument list
	...
	public class LambdaMetafactory
	{
		...
		/// </summary>
		public static readonly int FLAG_SERIALIZABLE = 1 << 0;
		...
		/// </summary>
		public static readonly int FLAG_MARKERS = 1 << 1;

		/// <summary>
		/// Flag for alternate metafactories indicating the lambda object requires
		/// additional bridge methods
		/// </summary>
		public static readonly int FLAG_BRIDGES = 1 << 2;

		private static readonly Class[] EMPTY_CLASS_ARRAY = new Class[0];
		private static readonly MethodType[] EMPTY_MT_ARRAY = new MethodType[0];
