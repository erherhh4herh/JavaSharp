...
namespace java.rmi
{
	...
	/// @since   JDK1.1
	/// </summary>
	public class UnmarshalException : RemoteException
	{

		/* indicate compatibility with JDK 1.1.x version of class */
		private new const long SerialVersionUID = 594380845140740218L;
		...
		/// @since JDK1.1 </param>
		public UnmarshalException(String s) : base(s)
		{
		}
		...
		/// @since JDK1.1 </param>
		public UnmarshalException(String s, Exception ex) : base(s, ex)
		{
		}
	}
