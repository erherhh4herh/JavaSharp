...
namespace java.security.acl
{
	...
	/// </para>
	/// class provides the default implementation of the interface.<para>
	/// 
...
//ORIGINAL LINE: public void setName(java.security.Principal caller, String name) throws NotOwnerException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public boolean addEntry(java.security.Principal caller, AclEntry entry) throws NotOwnerException;
		bool AddEntry(Principal caller, AclEntry entry);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public boolean removeEntry(java.security.Principal caller, AclEntry entry) throws NotOwnerException;
		bool RemoveEntry(Principal caller, AclEntry entry);
		...
		/// is allowed. </returns>
		IEnumerator<Permission> GetPermissions(Principal user);
		...
		bool CheckPermission(Principal principal, Permission permission);
