...
namespace java.security.spec
{
	...
	public class MGF1ParameterSpec : AlgorithmParameterSpec
	{
		...
		/// </summary>
		public static readonly MGF1ParameterSpec SHA1 = new MGF1ParameterSpec("SHA-1");
		/// <summary>
		/// The MGF1ParameterSpec which uses "SHA-224" message digest.
		/// </summary>
		public static readonly MGF1ParameterSpec SHA224 = new MGF1ParameterSpec("SHA-224");
		/// <summary>
