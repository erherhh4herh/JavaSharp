...
namespace java.security
{
	...
	/// 
	/// <para> A {@code DomainCombiner} is passed as a parameter to the
	...
	/// 
	/// </para>
	/// <para> The combine method takes two arguments.  The first argument represents
	...
	/// 
	/// </para>
	/// <para> The {@code combine} method investigates the two input arrays
	...
	/// 
	/// </para>
	/// <para> After the {@code AccessController.getContext} method
	...
	public interface DomainCombiner
	{
		...
		///          has no associated ProtectionDomains.<para>
		/// 
		/// </para>
		/// </param>
