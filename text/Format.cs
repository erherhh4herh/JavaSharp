...
//ORIGINAL LINE: public Object parseObject(String source) throws ParseException
		public virtual Object ParseObject(String source)
		{
			ParsePosition pos = new ParsePosition(0);
			Object result = ParseObject(source, pos);
			if (pos.Index_Renamed == 0)
			{
				throw new ParseException("Format.parseObject(String) failed", pos.ErrorIndex_Renamed);
			}
			return result;
		}
		...
		internal virtual AttributedCharacterIterator CreateAttributedCharacterIterator(String s)
		{
		...
		internal virtual AttributedCharacterIterator CreateAttributedCharacterIterator(String @string, AttributedCharacterIterator_Attribute key, Object value)
		{
		...
		/// @since 1.4
		/// </summary>
		public class Field : AttributedCharacterIterator_Attribute
		{

			// Proclaim serial compatibility with 1.4 FCS
			internal new const long SerialVersionUID = 276966692217360283L;
		...
		internal interface FieldDelegate
		{
			/// <summary>
